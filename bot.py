...
async def cmd_start(message: Message):
    ...
    if message.chat.type == "private":
        welcome_private = """
🔫 *ГИЛЬДИЯ БЕСПРЕДЕЛА*
_Бот для тех, у кого есть чувство юмора (и нет чувства меры)_

━━━━━━━━━━━━━━━━━━━━━━━━

👋 Здарова, одинокий странник!

Это бот для *групповых чатов*, где:
• Тётя Роза — пьяная цыганка-астролог — следит за вами
• AI пишет *сводки* вашего чата (с матом и унижениями)
• Можно *сжечь* друга на костре правды 🔥
• *Бухнуть* с кем-то и слить его секреты 🍻
• Получить *диагноз* от психиатра из подвала 🏥
• Послать человека *пососать* (философски) 🍭
• Написать *стих-унижение* в стиле Пушкина 📜

А ещё тут есть RPG с криминалом, казино и наездами!

━━━━━━━━━━━━━━━━━━━━━━━━

*Добавь меня в чат* и погнали деградировать вместе! 

⚠️ _Внимание: бот содержит мат, чёрный юмор и правду о вас. Если вы обидчивый — идите нахуй в другой бот._
...
Здесь:
• Тётя Роза следит за каждым твоим сообщением 👁
• AI генерирует *сводки* с унижениями и матом
• Можно *сжечь*, *бухнуть* и *унизить* друзей
• RPG: криминал, казино, наезды на лохов
...
async def cmd_help(message: Message):
    ...
    help_text = """
🔫 *ГИЛЬДИЯ БЕСПРЕДЕЛА*
_Бот для деградации и веселья_

━━━━━━━━━━━━━━━━━━━━━━━━

*🎭 ТЁТЯ РОЗА (AI-угар):*
/svodka — Сводка чата за 5ч (мат, унижения, правда)
/describe — Опишет твоё фото так, что пожалеешь
/poem @user — Стих-унижение в стиле Пушкина 📜
/диагноз @user — Диагноз от психиатра из подвала 🏥
/сжечь @user — Сжечь на костре правды 🔥
/бухнуть @user — Бухнуть и слить секреты 🍻
/пососи @user — Философское напутствие 🍭
...
/top — Топ авторитетов
/crime — Пойти на дело
/attack — Наехать на игрока

*🎰 КАЗИНО И ЛАВЭ:*
/casino — Слоты, кости, рулетка
/treasury — Воровской общак

*🖼️ ДРУГОЕ:*
/pic — Найти картинку по запросу
/achievements — Твои достижения

━━━━━━━━━━━━━━━━━━━━━━━━

⚠️ _Все команды работают в ответ на сообщение или с @username_

🚔 _Менты не дремлют, но мы тоже!_
"""
