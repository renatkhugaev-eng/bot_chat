...
CRINGE_PATTERNS = [
    ...
    r'жизнь — боль',
    r'всё плохо',
    r'хочу умереть',  # с юмором, не серьёзно
...
# Кринжовые фразы для AI-анализа
CRINGE_KEYWORDS = [
    'токсичн', 'абьюз', 'газлайт', 'триггер', 'травма', 'терапевт',
    'психолог', 'токсик', 'нарцисс', 'созависим', 'границы',
    'саморазвити', 'осознанност', 'медитаци', 'вселенн', 'энерги',
    'карма', 'судьб', 'знак', 'предназначен', 'миссия',
    'криптовалют', 'биткоин', 'нфт', 'метаверс', 'web3',
    'пассивный доход', 'финансовая свобода', 'бизнес идея',
]

# Шанс срабатывания (5% при обнаружении паттерна)
CRINGE_TRIGGER_CHANCE = 0.05
