...
WHO_IS_THIS_RESPONSES = [
    ...
    "🔞 Это? Профессиональный кончеглот. За день принимает больше спермы, чем банк крови за месяц.",
    "🔞 {name} — мусорка для спермы. Сливают туда всё — глотает и просит добавки.",
    "🔞 Кто? Ходячий контейнер для кончи. Литрами жрёт — и не толстеет.",
    "🔞 Это? Спермоприёмник с ногами. Функция одна — глотать.",
    "🔞 {name}? Глотательный аппарат. Ни капли мимо — всё в желудок.",
    "🔞 Это биологический унитаз для спермы. Слил — забыл.",
    "🔞 Кто это? Кончежор. Питается исключительно спермой. Протеиновая диета.",
    "🔞 {name}? Сперма-вампир. Высасывает досуха и идёт за следующим.",
    "🔞 Это? Человек-гандон. Только не выбрасывают, а сливают прямо в рот.",
    "🔞 {name} — живой презерватив. Собирает всё что кончают.",
    "🔞 Кто? Это кончехранилище. Там столько спермы, можно детей делать оптом.",
    "🔞 Это? Ёбаный спермоглот. Завтрак, обед, ужин — сперма.",
    "🔞 {name}? Профессиональный дояр. Только доит не коров, а мужиков.",
    "🔞 Это спермобаночка. Храним кончу до востребования.",
    "🔞 Кто это? Живая сперма-банка. Принимает вклады 24/7.",
    "🔞 {name}? Это желудок для спермы с телом вокруг.",
    "🔞 Это? Кончеглотатель со стажем. 10 лет опыта, ни одного рвотного позыва.",
    "🔞 {name} — спермоёмкость промышленная. Литраж неограничен.",
    "🔞 Кто? Ёбаный семяприёмник. Всё в себя, ничего мимо.",
    
    # Шлюхо-тема (20)
    "🔞 {name}? Это шлюха. Просто шлюха. Шлюха и всё.",
    "🔞 Кто это? Блядища районного масштаба. Ебалась со всем подъездом.",
    "🔞 Это? Подстилка общего пользования. Бесплатно и круглосуточно.",
    "🔞 {name} — профессиональная блядь. Диплом с отличием.",
    "🔞 Кто? Шлюхоёбина. Родилась блядью, живёт блядью, сдохнет блядью.",
    "🔞 Это? Вокзальная подстилка. Там все были.",
    "🔞 {name}? Ебливая тварь. Ноги раздвигаются автоматически.",
    "🔞 Кто это? Бесплатная проститутка. Даже денег не берёт — для удовольствия.",
    "🔞 Это блядина. Профессия — шлюха. Хобби — шлюха. Мечта — ещё больше шлюхи.",
    "🔞 {name}? Ёбаная давалка. Даёт всем без разбора.",
    "🔞 Это? Шлюха в кубе. Ебётся в три дырки одновременно.",
    "🔞 Кто? Местная блядь. Знает каждый — пользовался каждый.",
    "🔞 {name} — публичная женщина. Очень публичная. Слишком публичная.",
    "🔞 Это? Шлюшара. Ебалась столько раз — сбилась со счёта на первой неделе.",
    "🔞 Кто это? Выблядок-переросток. Мамка была шлюхой — яблоко от яблони.",
    "🔞 {name}? Блядь со стажем. 10 лет непрерывного стажа.",
    "🔞 Это профессиональная шлюха. Любительский разряд давно позади.",
    "🔞 Кто? Ебучая тварюга. Ебёт всё что движется. И не движется тоже.",
    "🔞 {name}? Это портовая шлюха. Моряки плачут от ностальгии.",
    "🔞 Это? Блядища уличная. Асфальт протёрла коленями.",
    
    # Ротовая тема (20)
    "🔞 {name}? Это ходячий минет. Рот создан для члена.",
    "🔞 Кто это? Сосалка профессиональная. Сертификат висит на стене.",
    "🔞 Это? Ротовая дырка с телом. Функция — сосать.",
    "🔞 {name} — хуесос-самоучка. Природный талант.",
    "🔞 Кто? Отсосун со стажем. Рот не закрывается с детства.",
    "🔞 Это? Живой глорихол. Дырка в стене сортира — вот что это.",
    "🔞 {name}? Профессиональный минетчик. Языком творит чудеса.",
    "🔞 Кто это? Сосательный аппарат. Модель последняя, с глубоким горлом.",
    "🔞 Это? Человек-минет. Ходит и сосёт — вот и вся жизнь.",
    "🔞 {name} — ротовая шлюха. Рот = пизда, только на лице.",
    "🔞 Кто? Это глоточник. Берёт до яиц, не морщится.",
    "🔞 {name}? Члено-сосательная машина. Безотказная.",
    "🔞 Это? Губошлёп. Губами работает — головой нет.",
    "🔞 Кто это? Минет на ножках. Ходит-бродит, ищет что пососать.",
    "🔞 {name}? Оральный террорист. Ни один хуй не ушёл обиженным.",
    "🔞 Это пылесос для члена. Всасывает с характерным звуком.",
    "🔞 Кто? Ротожоп. Жопа и рот — одно и то же. Оба рабочие.",
    "🔞 {name} — сосун-универсал. Любой размер, любая форма.",
    "🔞 Это? Язычник. В религиозном смысле — нет. В ротовом — да.",
    "🔞 Кто это? Глоточная проститутка. Горло = рабочий инструмент.",
    ...
    "🔞 Кто это? Ошибка природы. Надо было проглотить — а выносили.",
    "🔞 Это? Человеческий мусор. Место — на помойке.",
    "🔞 {name} — биоотход. Утилизации подлежит.",
    "🔞 Кто? Тварь ебучая. Тварь — потому что тварь.",
    "🔞 Это? Параша. В неё ссут, срут и кончают.",
    "🔞 {name}? Унитаз с ногами. Говно принимает на постоянной основе.",
    "🔞 Кто это? Выблядок. Папка не признал — и правильно сделал.",
    "🔞 Это ёбаный урод. Ебали — и стал уродом.",
    "🔞 {name}? Отброс общества. Общество отбросило — не жалеет.",
    "🔞 Кто? Мразота. Мразь + срамота = мразота.",
    "🔞 Это? Конченый. В обоих смыслах конченый.",
    "🔞 {name} — человек-говно. Состав: 100% говно.",
    "🔞 Кто это? Пиздёныш. Из пизды вылез — в пизду и катится.",
...
async def who_is_this_handler(message: Message):
    ...
    response = random.choice(WHO_IS_THIS_RESPONSES).format(name=target_name)
